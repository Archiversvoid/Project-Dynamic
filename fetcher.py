...
# Handles format extraction, downloads, and age-gate detection.
...
def download_video(url: str, format_id=None, out_dir: str = "downloads",
                   is_audio: bool = False, selected_fid=None):
    # Support both positional and keyword call styles from main.py
